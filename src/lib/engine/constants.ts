...
/**
 * Phase 4 (items 9–12) — Local Housing Allowance (LHA) monthly rent floors in
 * pennies, keyed by city id and bedroom count. Used to anchor newly generated
...
/** Phase 4 — bedroom band from net internal sqft. */
export function bedroomsForSqft(sqft: number): number {
  if (sqft < 500) return 1;
  if (sqft < 750) return 2;
  if (sqft < 1100) return 3;
  return 4;
}
...
export const AVAILABLE_PROPERTIES: Property[] = [
  ...
  { id: "2", name: "12 Park Road South", type: "residential", price: toPennies(68000), value: toPennies(68000), neighborhood: "Linthorpe", monthlyIncome: toPennies(395), marketTrend: "stable", yield: 7.0, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0, epcRating: 'E' as const },
  { id: "3", name: "78 Acklam Road", type: "residential", price: toPennies(95000), value: toPennies(95000), neighborhood: "Acklam", monthlyIncome: toPennies(545), marketTrend: "up", yield: 6.9, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0, epcRating: 'D' as const },
  { id: "4", name: "156 Cargo Fleet Lane", type: "residential", price: toPennies(58000), value: toPennies(58000), neighborhood: "Port Clarence", monthlyIncome: toPennies(340), marketTrend: "stable", yield: 7.0, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0, epcRating: 'E' as const },
  { id: "5", name: "89 Borough Road", type: "residential", price: toPennies(52000), value: toPennies(52000), neighborhood: "North Ormesby", monthlyIncome: toPennies(310), marketTrend: "stable", yield: 7.2, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0, epcRating: 'E' as const },
  { id: "6", name: "67 Roman Road", type: "residential", price: toPennies(82000), value: toPennies(82000), neighborhood: "Pallister Park", monthlyIncome: toPennies(470), marketTrend: "down", yield: 6.9, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0, epcRating: 'D' as const },
  { id: "7", name: "91 Trimdon Avenue", type: "residential", price: toPennies(72000), value: toPennies(72000), neighborhood: "Acklam", monthlyIncome: toPennies(420), marketTrend: "stable", yield: 7.0, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0, epcRating: 'D' as const },
  { id: "8", name: "23 Newport Road", type: "residential", price: toPennies(64000), value: toPennies(64000), neighborhood: "Middlesbrough Centre", monthlyIncome: toPennies(375), marketTrend: "up", yield: 7.0, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0, epcRating: 'E' as const },
  // Level 2
  { id: "9", name: "23 Marton Road", type: "residential", price: toPennies(120000), value: toPennies(120000), neighborhood: "Marton", monthlyIncome: toPennies(700), marketTrend: "up", yield: 7.0, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0, epcRating: 'D' as const },
  { id: "10", name: "34 Southfield Road", type: "residential", price: toPennies(145000), value: toPennies(145000), neighborhood: "Middlesbrough Centre", monthlyIncome: toPennies(810), marketTrend: "up", yield: 6.7, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0, epcRating: 'D' as const },
  { id: "11", name: "Unit 5 Albert Road", type: "commercial", price: toPennies(180000), value: toPennies(180000), neighborhood: "Middlesbrough Centre", monthlyIncome: toPennies(1350), marketTrend: "up", yield: 9.0, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0, epcRating: 'D' as const },
  { id: "12", name: "Shop A, Linthorpe Road", type: "commercial", price: toPennies(165000), value: toPennies(165000), neighborhood: "Linthorpe", monthlyIncome: toPennies(1240), marketTrend: "stable", yield: 9.0, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0, epcRating: 'D' as const },
  { id: "13", name: "45 Parliament Road", type: "residential", price: toPennies(135000), value: toPennies(135000), neighborhood: "Linthorpe", monthlyIncome: toPennies(780), marketTrend: "up", yield: 6.9, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0, epcRating: 'D' as const },
