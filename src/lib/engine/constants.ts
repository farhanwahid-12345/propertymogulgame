...
export const AVAILABLE_PROPERTIES: Property[] = [
  ...
  { id: "1", name: "45 Linthorpe Road", type: "residential", price: toPennies(75000), value: toPennies(75000), neighborhood: "Linthorpe", monthlyIncome: toPennies(578), marketTrend: "up", yield: 9.2, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0, epcRating: 'D' as const },
  { id: "2", name: "12 Park Road South", type: "residential", price: toPennies(68000), value: toPennies(68000), neighborhood: "Linthorpe", monthlyIncome: toPennies(468), marketTrend: "stable", yield: 8.3, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0, epcRating: 'E' as const },
  { id: "3", name: "78 Acklam Road", type: "residential", price: toPennies(95000), value: toPennies(95000), neighborhood: "Acklam", monthlyIncome: toPennies(688), marketTrend: "up", yield: 8.7, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0, epcRating: 'D' as const },
  { id: "4", name: "156 Cargo Fleet Lane", type: "residential", price: toPennies(58000), value: toPennies(58000), neighborhood: "Port Clarence", monthlyIncome: toPennies(468), marketTrend: "stable", yield: 9.7, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0, epcRating: 'E' as const },
  { id: "5", name: "89 Borough Road", type: "residential", price: toPennies(52000), value: toPennies(52000), neighborhood: "North Ormesby", monthlyIncome: toPennies(468), marketTrend: "stable", yield: 10.8, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0, epcRating: 'E' as const },
  { id: "6", name: "67 Roman Road", type: "residential", price: toPennies(82000), value: toPennies(82000), neighborhood: "Pallister Park", monthlyIncome: toPennies(578), marketTrend: "down", yield: 8.5, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0, epcRating: 'D' as const },
  { id: "7", name: "91 Trimdon Avenue", type: "residential", price: toPennies(72000), value: toPennies(72000), neighborhood: "Acklam", monthlyIncome: toPennies(578), marketTrend: "stable", yield: 9.6, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0, epcRating: 'D' as const },
  { id: "8", name: "23 Newport Road", type: "residential", price: toPennies(64000), value: toPennies(64000), neighborhood: "Middlesbrough Centre", monthlyIncome: toPennies(468), marketTrend: "up", yield: 8.8, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0, epcRating: 'E' as const },
  // Level 2
  { id: "9", name: "23 Marton Road", type: "residential", price: toPennies(120000), value: toPennies(120000), neighborhood: "Marton", monthlyIncome: toPennies(688), marketTrend: "up", yield: 6.9, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0, epcRating: 'D' as const },
  { id: "10", name: "34 Southfield Road", type: "residential", price: toPennies(145000), value: toPennies(145000), neighborhood: "Middlesbrough Centre", monthlyIncome: toPennies(688), marketTrend: "up", yield: 5.7, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0, epcRating: 'D' as const },
