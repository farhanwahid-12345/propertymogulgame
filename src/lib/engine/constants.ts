...
export const AVAILABLE_PROPERTIES: Property[] = [
  ...
  { id: "1", name: "45 Linthorpe Road", type: "residential", price: toPennies(75000), value: toPennies(75000), neighborhood: "Linthorpe", monthlyIncome: toPennies(968), marketTrend: "up", yield: 15.5, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  { id: "2", name: "12 Park Road South", type: "residential", price: toPennies(68000), value: toPennies(68000), neighborhood: "Linthorpe", monthlyIncome: toPennies(680), marketTrend: "stable", yield: 12.0, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  { id: "3", name: "78 Acklam Road", type: "residential", price: toPennies(95000), value: toPennies(95000), neighborhood: "Acklam", monthlyIncome: toPennies(1029), marketTrend: "up", yield: 13.0, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  { id: "4", name: "156 Cargo Fleet Lane", type: "residential", price: toPennies(58000), value: toPennies(58000), neighborhood: "Port Clarence", monthlyIncome: toPennies(773), marketTrend: "stable", yield: 16.0, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  { id: "5", name: "89 Borough Road", type: "residential", price: toPennies(52000), value: toPennies(52000), neighborhood: "North Ormesby", monthlyIncome: toPennies(628), marketTrend: "stable", yield: 14.5, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  { id: "6", name: "67 Roman Road", type: "residential", price: toPennies(82000), value: toPennies(82000), neighborhood: "Pallister Park", monthlyIncome: toPennies(786), marketTrend: "down", yield: 11.5, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  { id: "7", name: "91 Trimdon Avenue", type: "residential", price: toPennies(72000), value: toPennies(72000), neighborhood: "Acklam", monthlyIncome: toPennies(810), marketTrend: "stable", yield: 13.5, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  { id: "8", name: "23 Newport Road", type: "residential", price: toPennies(64000), value: toPennies(64000), neighborhood: "Middlesbrough Centre", monthlyIncome: toPennies(587), marketTrend: "up", yield: 11.0, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  // Level 2
  { id: "9", name: "23 Marton Road", type: "residential", price: toPennies(120000), value: toPennies(120000), neighborhood: "Marton", monthlyIncome: toPennies(1200), marketTrend: "up", yield: 12.0, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  { id: "10", name: "34 Southfield Road", type: "residential", price: toPennies(145000), value: toPennies(145000), neighborhood: "Middlesbrough Centre", monthlyIncome: toPennies(1450), marketTrend: "up", yield: 12.0, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  { id: "11", name: "Unit 5 Albert Road", type: "commercial", price: toPennies(180000), value: toPennies(180000), neighborhood: "Middlesbrough Centre", monthlyIncome: toPennies(1500), marketTrend: "up", yield: 10.0, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  { id: "12", name: "Shop A, Linthorpe Road", type: "commercial", price: toPennies(165000), value: toPennies(165000), neighborhood: "Linthorpe", monthlyIncome: toPennies(1375), marketTrend: "stable", yield: 10.0, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  { id: "13", name: "45 Parliament Road", type: "residential", price: toPennies(135000), value: toPennies(135000), neighborhood: "Linthorpe", monthlyIncome: toPennies(1350), marketTrend: "up", yield: 12.0, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  // Level 3
  { id: "14", name: "Captain Cook Square Unit", type: "commercial", price: toPennies(250000), value: toPennies(250000), neighborhood: "Captain Cook Square", monthlyIncome: toPennies(1800), marketTrend: "down", yield: 8.6, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  { id: "15", name: "Warehouse, Vulcan Street", type: "commercial", price: toPennies(320000), value: toPennies(320000), neighborhood: "South Bank", monthlyIncome: toPennies(2100), marketTrend: "stable", yield: 7.9, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  { id: "16", name: "8 The Avenue, Nunthorpe", type: "luxury", price: toPennies(385000), value: toPennies(385000), neighborhood: "Nunthorpe", monthlyIncome: toPennies(2400), marketTrend: "up", yield: 7.5, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  { id: "17", name: "Modern Townhouse, Hemlington", type: "luxury", price: toPennies(295000), value: toPennies(295000), neighborhood: "Hemlington", monthlyIncome: toPennies(1950), marketTrend: "up", yield: 7.9, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  // Level 4
  { id: "18", name: "Executive Home, Nunthorpe", type: "luxury", price: toPennies(550000), value: toPennies(550000), neighborhood: "Nunthorpe", monthlyIncome: toPennies(3200), marketTrend: "stable", yield: 7.0, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  { id: "19", name: "Luxury Penthouse", type: "luxury", price: toPennies(625000), value: toPennies(625000), neighborhood: "Middlesbrough Centre", monthlyIncome: toPennies(3500), marketTrend: "up", yield: 6.7, lastRentIncrease: 0, condition: "premium" as const, monthsSinceLastRenovation: 0 },
  { id: "20", name: "Prime Commercial Unit", type: "commercial", price: toPennies(720000), value: toPennies(720000), neighborhood: "Middlesbrough Centre", monthlyIncome: toPennies(4200), marketTrend: "up", yield: 7.0, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  // Level 5
  { id: "21", name: "Waterfront Development", type: "luxury", price: toPennies(1200000), value: toPennies(1200000), neighborhood: "Middlesbrough Centre", monthlyIncome: toPennies(7000), marketTrend: "stable", yield: 7.0, lastRentIncrease: 0, condition: "premium" as const, monthsSinceLastRenovation: 0 },
  { id: "22", name: "Historic Mansion", type: "luxury", price: toPennies(1500000), value: toPennies(1500000), neighborhood: "Nunthorpe", monthlyIncome: toPennies(8500), marketTrend: "up", yield: 6.8, lastRentIncrease: 0, condition: "premium" as const, monthsSinceLastRenovation: 0 },
];
