...
export const AVAILABLE_PROPERTIES: Property[] = [
  ...
  { id: "1", name: "45 Linthorpe Road", type: "residential", price: toPennies(75000), value: toPennies(75000), neighborhood: "Linthorpe", monthlyIncome: toPennies(968), image: "https://images.unsplash.com/photo-1568605114967-8130f3a36994?w=400&h=300&fit=crop", marketTrend: "up", yield: 15.5, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  { id: "2", name: "12 Park Road South", type: "residential", price: toPennies(68000), value: toPennies(68000), neighborhood: "Linthorpe", monthlyIncome: toPennies(680), image: "https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=400&h=300&fit=crop", marketTrend: "stable", yield: 12.0, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  { id: "3", name: "78 Acklam Road", type: "residential", price: toPennies(95000), value: toPennies(95000), neighborhood: "Acklam", monthlyIncome: toPennies(1029), image: "https://images.unsplash.com/photo-1449157291145-7efd050a4d0e?w=400&h=300&fit=crop", marketTrend: "up", yield: 13.0, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  { id: "4", name: "156 Cargo Fleet Lane", type: "residential", price: toPennies(58000), value: toPennies(58000), neighborhood: "Port Clarence", monthlyIncome: toPennies(773), image: "https://images.unsplash.com/photo-1459767129954-1b1c1f9b9ace?w=400&h=300&fit=crop", marketTrend: "stable", yield: 16.0, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  { id: "5", name: "89 Borough Road", type: "residential", price: toPennies(52000), value: toPennies(52000), neighborhood: "North Ormesby", monthlyIncome: toPennies(628), image: "https://images.unsplash.com/photo-1460574283810-2aab119d8511?w=400&h=300&fit=crop", marketTrend: "stable", yield: 14.5, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  { id: "6", name: "67 Roman Road", type: "residential", price: toPennies(82000), value: toPennies(82000), neighborhood: "Pallister Park", monthlyIncome: toPennies(786), image: "https://images.unsplash.com/photo-1487958449943-2429e8be8625?w=400&h=300&fit=crop", marketTrend: "down", yield: 11.5, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  { id: "7", name: "91 Trimdon Avenue", type: "residential", price: toPennies(72000), value: toPennies(72000), neighborhood: "Acklam", monthlyIncome: toPennies(810), image: "https://images.unsplash.com/photo-1496307653780-42ee777d4833?w=400&h=300&fit=crop", marketTrend: "stable", yield: 13.5, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  { id: "8", name: "23 Newport Road", type: "residential", price: toPennies(64000), value: toPennies(64000), neighborhood: "Middlesbrough Centre", monthlyIncome: toPennies(587), image: "https://images.unsplash.com/photo-1431576901776-e539bd916ba2?w=400&h=300&fit=crop", marketTrend: "up", yield: 11.0, lastRentIncrease: 0, condition: "standard" as const, monthsSinceLastRenovation: 0 },
  // Level 2
