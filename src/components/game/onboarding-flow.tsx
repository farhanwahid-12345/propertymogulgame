...
const TOUR_STEPS: TourStep[] = [
  ...
  { id: 'tour-ops',    icon: ClipboardList, title: "Operations", index: 4, tab: 'bank', scrollId: 'section-ops',
  ...
  { id: 'tour-monthend', icon: CalendarDays, title: "Month End", index: 5, tab: undefined, scrollId: 'game-clock-controls',
