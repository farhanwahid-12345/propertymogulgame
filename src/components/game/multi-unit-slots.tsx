...
export interface MultiUnitSlot {
  ...
  rentPounds?: number;
  pendingEviction?: {
    ground: 'rent_arrears' | 'landlord_sale' | 'landlord_move_in' | 'antisocial_behaviour' | 'lease_expiry' | 'tenant_default' | 'break_clause' | 'commercial_forfeiture' | 'commercial_arrears';
